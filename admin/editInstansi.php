        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom page-heading">
                <div class='col-lg-12'>
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Edit Data Instansi </b></label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            $id = $_GET['kode_instansi'];

                            // Fetech user data based on id
                            $result = mysqli_query($mysqli, "SELECT * FROM tb_instansi WHERE kode_instansi='$id'");

                            while ($user_data = mysqli_fetch_array($result)) {
                                $kode_instansi = $user_data['kode_instansi'];
                                $nama_instansi = $user_data['nama_instansi'];
                                $deskripsi = $user_data['deskripsi'];
                            }
                            ?>
                            <div class="ibox-content">
                                <form name="update_user" method="post" action="database/updateInstansi.php"
                                    class="form-horizontal">

                                    <div class="form-group"><label class="col-lg-2 control-label">Kode Instansi</label>

                                        <div class="col-lg-8"><input type="text" value="<?php echo $kode_instansi; ?>"
                                                class="form-control" disabled>
                                            <input type="hidden" name="kode_instansi"
                                                value="<?php echo $kode_instansi; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Nama Instansi</label>

                                        <div class="col-lg-8"><input type="text" name="nama_instansi"
                                                value="<?php echo $nama_instansi; ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <input type="hidden" name="id" value=<?php echo $_GET['kode_instansi']; ?>>
                                            <button class="btn btn-sm btn-primary" type="submit"
                                                name="update">Update</button>
                                            <a href='instansi.php' style='margin-left:2%'>Cancel</a>
                                        </div>
                                    </div>
                                </form>
