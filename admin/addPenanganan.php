        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom page-heading">
                <div class="col-lg-12">
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Tambah Data Penanganan </b></label>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form name="form1" method="post" action="database/prosesaddPenanganan.php"
                                    enctype="multipart/form-data" class="form-horizontal">

                                    <div class="form-group"><label class="col-lg-2 control-label">Id Penanganan</label>

                                        <div class="col-lg-8"><input id="id_penanganan" name="id_penanganan" type="text"
                                                class="form-control required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Jenis Penanganan</label>
                                        <div class="col-lg-8"><select class=" form-control required" name="jenis_pena">
                                                <option value="Renovasi">Renovasi</option>
                                                <option value="Rehabilitasi">Rehabilitasi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Sumber
                                            Pendanaan</label>

                                        <div class="col-lg-8"><input id="sumber_dana" name="sumber_dana" type="text"
                                                class="form-control required">
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Tanggal
                                            Renovasi</label>
                                        <div class="col-lg-8">
                                            <input id="tgl_renovasi" name="tgl_renovasi" type="date"
                                                class="form-control required">
                                        </div>
                                    </div>

                                    <div class="form-group"><label class="col-lg-2 control-label">Dana Alokasi
                                            Pembiayaan</label>
                                        <div class="col-lg-8">
                                            <input id="alokasi_dana" name="alokasi_dana" type="text"
                                                class="form-control required">
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Jenis
                                            Renovasi/Rehabilitasi</label>
                                        <div class="col-lg-8">
                                            <select class="form-control required" name="jenis_renovasi">
                                    ...
                                    <div class="form-group"><label class="col-lg-2 control-label">Penjelasan
                                            Rehabilitasi / Renovasi</label>
                                        <div class="col-lg-8">
                                            <textarea id="penjelasan" name="penjelasan" class="form-control"></textarea>
                                            <!-- <input id="penjelasan" name="penjelasan" type="text" class="form-control"> -->
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Foto Rehabilitasi /
                                            Renovasi</label>
                                        <div class="col-lg-8">
                                            <input id="foto_penanganan" name="foto_penanganan[]" type="file" multiple
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Dokumen Rehabilitasi /
                                            Renovasi</label>
                                        <div class="col-lg-8">
                                            <input id="dokumen_pena" name="dokumen_pena[]" type="file" multiple
