        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom page-heading">
                <div class='col-lg-12'>
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Edit Fungsi </b></label>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            $result = mysqli_query($mysqli, "SELECT * FROM tb_fungsi WHERE kode_fungsi='$id'");

                            while ($user_data = mysqli_fetch_array($result)) {
                                $kode_fungsi = $user_data['kode_fungsi'];
                                $nama_fungsi = $user_data['nama_fungsi'];
                                $deskripsi = $user_data['deskripsi'];
                            }
                            ?>
                            <div class="ibox-content">
                                <form name="update_user" method="post" action="database/updateFungsi.php"
                                    class="form-horizontal">

                                    <div class="form-group"><label class="col-lg-2 control-label">Kode OPD</label>

                                        <div class="col-lg-8"><input type="text" value="<?php echo $kode_fungsi; ?>"
                                                class="form-control" disabled>
                                            <input type="hidden" name="kode_fungsi" value="<?php echo $kode_fungsi; ?>"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Nama OPD</label>

                                        <div class="col-lg-8"><input type="text" name="nama_fungsi"
                                                value="<?php echo $nama_fungsi; ?>" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            <input type="hidden" name="id" value=<?php echo $_GET['kode_fungsi']; ?>>
                                            <button class="btn btn-sm btn-primary" type="submit"
                                                name="update">Update</button>
                                            <a href='fungsi.php' style='margin-left:2%'>Cancel</a>
                                        </div>
                                    </div>
                                </form>
