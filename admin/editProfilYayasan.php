...
$id = $_GET['id'];
$sql = "select * from profilyayasan where PROFILYAYASAN_ID = $id";
$hasil = mysqli_query( $mysqli, $sql );
   while ( $d = mysqli_fetch_array( $hasil ) ) {
       ?>
                                <form name="form1" id="form" method="post"
                                    action="database/updateProfilYayasan.php?id=<?php echo $d['PROFILYAYASAN_ID']; ?>"
                                    ...
                                    <div class="form-group"><label class="col-lg-2 control-label">Deskripsi*
                                        ...
                                        <div class="col-lg-8">
                                            <textarea id="editor2" style="height:40%" name="deskripsi" rows="6"
                                                cols="40" class="form-control"><?php echo $d['DESKRIPSI']; ?></textarea>
