        ...
        <div id='page-wrapper' class='gray-bg'>
            ...
            <div class='row wrapper border-bottom page-heading'>
                <div class='col-lg-12'>
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Data Fungsi </b></label>
                    ...
                    <div class='col-lg-12'>
                        <div class='ibox float-e-margins'>
                            <div class='ibox-title'>
                                <h5>Tambah Data Fungsi</h5>
                                <div class='ibox-tools'>

                                </div>
                            </div>
                            <div class='ibox-content'>
                                <form action='addFungsi.php' method='post' name='form1' class='form-horizontal'>

                                    <div class='form-group'><label class='col-lg-2 control-label'>Kode Fungsi</label>

                                        <div class='col-lg-8'><input type='text' name='kode_fungsi'
                                                placeholder='Kode Instansi' class='form-control'>
                                        </div>
                                    </div>
                                    <div class='form-group'><label class='col-lg-2 control-label'>Nama Fungsi</label>
...
if ( isset( $_POST['submit'] ) ) {
    ...
    if ( $result ) {
	  ...
	  <script type='text/javascript'>
		...
		window.location.replace('fungsi.php');
		} ,1500);	
	  </script>";
    } else {
        echo "
