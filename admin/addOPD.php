...
?>
        ...
        <div id='page-wrapper' class='gray-bg'>
            ...
            <div class='row wrapper border-bottom page-heading'>
                <div class='col-lg-12'>
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Data Organisasi Perangkat Daerah (
                            OPD ) </b></label>
    ...
    if ( isset( $_POST['submit'] ) ) {
        ...
        $deskripsi_log = 'Menambahkan Data OPD';
	  ...
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data OPD Berhasil Disimpan',
				type: 'success',
				timer: 1500,
