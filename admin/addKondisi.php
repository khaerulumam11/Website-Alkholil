...
<head>
    ...
    <title>Tambah Kondisi Bangunan</title>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class='row wrapper border-bottom page-heading'>
                <div class='col-lg-12'>
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Tambah Data Kondisi </b></label>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form name="form1" method="post" action="database/prosesaddKondisi.php"
                                    enctype="multipart/form-data" class="form-horizontal" style="margin-top:2%">

                                    <div class="form-group"><label class="col-lg-2 control-label">ID Kondisi</label>

                                        <div class="col-lg-8"><input id="id_kondisi" name="id_kondisi" type="text"
                                                class="form-control required">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Judul</label>
                                        <div class="col-lg-8"><input id="judul_kondisi" name="judul_kondisi" type="text"
                                                class="form-control required">
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Deskripsi</label>

                                        <div class="col-lg-8"><textarea id="deskripsi_kondisi" name="deskripsi_kondisi"
                                                class="form-control required"></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group"><label class="col-lg-2 control-label">Foto Kondisi
                                            Bangunan</label>
                                        <div class="col-lg-8">
                                            <input id="foto_kondisi" name="foto_kondisi[]" type="file" multiple
