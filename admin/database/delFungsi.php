...
$deskripsi_log = "Menghapus data fungsi dengan ID Fungsi $id";
...
$result = mysqli_query( $mysqli, "delete from tb_fungsi where kode_fungsi='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Fungsi Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Fungsi Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
