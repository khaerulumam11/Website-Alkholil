...
$deskripsi_log = "Menambahkan Dokumen Struktur dengan ID Struktur $id";
...
foreach ( $_FILES['file']['tmp_name'] as $key=>$tmp_name ) {
    ...
    $folder_bg = "../dokumen/dokumenStruktur/$file_tmp_bg";
    ...
    if ( in_array( $ext, $extension_doc ) ) {
        ...
        $result = mysqli_query( $mysqli, "INSERT INTO `dokumen_struktur` (`dokument`,`id_bangunan`) VALUES ('$file_tmp_bg','$id')" );
    } else {
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Struktur Berhasil Ditambahkan',
				type: 'success',
				timer: 1500,
