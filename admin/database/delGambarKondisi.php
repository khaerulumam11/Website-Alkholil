...
$deskripsi_log = "Menghapus Gambar Kondisi dengan ID Kondisi $id ";
...
$result = mysqli_query( $mysqli, "delete from gambar_kondisi where id_gambarkondisi='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Foto Kondisi Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Foto Kondisi Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
