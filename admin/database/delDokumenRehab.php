...
$deskripsi_log = "Menghapus Dokumen Penanganan dengan ID Penanganan $id ";
...
$result = mysqli_query( $mysqli, "delete from dokumen_penanganan where id='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Penanganan Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Penanganan Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
