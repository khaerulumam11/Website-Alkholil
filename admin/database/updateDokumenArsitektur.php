...
$deskripsi_log = "Menambahkan Dokumen Arsitektur dengan ID Arsitektur $id";
...
foreach ( $_FILES['file']['tmp_name'] as $key=>$tmp_name ) {
    ...
    $folder_bg = "../dokumen/dokumenArsitektur/$file_tmp_bg";
    ...
    if ( in_array( $ext, $extension_doc ) ) {
        ...
        $result = mysqli_query( $mysqli, "INSERT INTO `dokumen_arsitektur` (`dokumen`,`id_bangunan`) VALUES ('$file_tmp_bg','$id')" );
    } else {
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Arsitektur Berhasil Ditambahkan',
				type: 'success',
				timer: 1500,
