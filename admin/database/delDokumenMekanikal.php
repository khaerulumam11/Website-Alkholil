...
$deskripsi_log = "Menghapus Dokumen Mekanikal dengan ID Mekanikal $id ";
...
$result = mysqli_query( $mysqli, "delete from dokumen_mekanikal where id='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Mekanikal Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Mekanikal Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
