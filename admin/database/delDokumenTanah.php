...
$deskripsi_log = "Menghapus Dokumen Tanah dengan ID Tanah $id ";
...
$result = mysqli_query( $mysqli, "delete from dokumen_tanah where id='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Tanah Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Tanah Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
