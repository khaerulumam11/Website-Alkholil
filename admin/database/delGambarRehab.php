...
$deskripsi_log = "Menghapus Foto Penanganan dengan ID Penanganan $id ";
...
$result = mysqli_query( $mysqli, "delete from gambar_penanganan where id='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Foto Penanganan Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Foto Penanganan Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
