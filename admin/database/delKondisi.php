...
$deskripsi_log = "Menghapus Data Kondisi dengan ID Kondisi $id ";
...
$result = mysqli_query( $mysqli, "delete from tb_kondisi where id_kondisi='$id'" );
$result1 = mysqli_query( $mysqli, "delete from gambar_kondisi where id_gambarkondisi='$id'" );
...
if ( $result && $result1 ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Kondisi Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Kondisi Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
