...
$deskripsi_log = "Menghapus Foto Bangunan dengan ID Bangunan $id ";
...
$result = mysqli_query( $mysqli, "delete from gambar_bangunan where id_gambar='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Foto Bangunan Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Foto Bangunan Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
