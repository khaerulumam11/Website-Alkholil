...
$deskripsi_log = "Menambahkan Dokumen Mekanikal dengan ID Mekanikal $id";
...
foreach ( $_FILES['file']['tmp_name'] as $key=>$tmp_name ) {
    ...
    $folder_bg = "../dokumen/dokumenUtilitas/$file_tmp_bg";
    ...
    if ( in_array( $ext, $extension_doc ) ) {
        ...
        $result = mysqli_query( $mysqli, "INSERT INTO `dokumen_mekanikal` (`dokumen`,`id_bangunan`) VALUES ('$file_tmp_bg','$id')" );
    } else {
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Mekanikal Berhasil Ditambahkan',
				type: 'success',
				timer: 1500,
