...
$deskripsi_log = "Menghapus Data Penanganan dengan ID Penanganan $id ";
...
$result = mysqli_query( $mysqli, "delete from tb_penanganan where id_penanganan='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Penanganan Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Penanganan Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
