...
$deskripsi_log = "Menghapus Dokumen Struktur dengan ID Struktur $id ";
...
$result = mysqli_query( $mysqli, "delete from dokumen_struktur where id='$id'" );
...
if ( $result ) {
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Struktur Berhasil Dihapus',
				type: 'success',
				timer: 1500,
    ...
    echo "
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Dokumen Struktur Gagal Dihapus',
				type: 'error',
				timer: 1500,
				showConfirmButton: true
			});		
