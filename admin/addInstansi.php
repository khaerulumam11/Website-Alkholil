        ...
        <div id='page-wrapper' class='gray-bg'>
            ...
            <div class='row wrapper border-bottom page-heading'>
                <div class='col-lg-12'>
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Data Instansi </b></label>
                    ...
                    <div class='col-lg-12'>
                        <div class='ibox float-e-margins'>
                            <div class='ibox-title'>
                                <h5>Tambah Data Instansi</h5>
                                <div class='ibox-tools'>

                                </div>
                            </div>
                            <div class='ibox-content'>
                                <form action='addInstansi.php' method='post' name='form1' class='form-horizontal'>

                                    <div class='form-group'><label class='col-lg-2 control-label'>Kode Instansi</label>

                                        <div class='col-lg-8'><input type='text' name='kode_instansi'
                                                placeholder='Kode Instansi' class='form-control'>
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-group'>
                                        <div class='col-lg-offset-2 col-lg-10'>
                                            ...
                                            <a href='opd.php' style='margin-left:2%'>Cancel</a>
                                        </div>
                                    </div>
                                </form>
...
if ( isset( $_POST['submit'] ) ) {
    ...
    $result = mysqli_query( $mysqli, "INSERT INTO tb_instansi (`kode_instansi`, `nama_instansi`, `deskripsi`) VALUES ('$kode_instansi','$nama_instansi','$deskripsi')" );

    $nama_user = $_SESSION['nama'];
    $deskripsi_log = 'Menambahkan Data Instansi';
    ...
    if ( $result ) {
	  ...
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Instansi Berhasil Disimpan',
				type: 'success',
				timer: 1500,
	  ...
	  <script type='text/javascript'>
		setTimeout(function () { 	
			swal({
				title: 'Data Instansi Gagal Disimpan',
				type: 'danger',
				timer: 1500,
				showConfirmButton: true
			});		
