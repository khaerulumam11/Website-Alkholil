        ...
        <div id='page-wrapper' class='gray-bg'>
            ...
            <div class='row wrapper border-bottom page-heading'>
                <div class='col-lg-12'>
                    ...
                    <label style="font-size:32px;margin-top:3%; margin-left:1%"><b>Edit Data Arsitektur </b></label>
                    ...
                    <div class='col-lg-12'>
                        <div class='tabs-container'>
                            <ul class='nav nav-tabs'>
                                <li class='active'><a data-toggle='tab' href='#tab-1'> Data Arsitektur</a></li>
                                <li class=''><a data-toggle='tab' href='#tab-2'> Dokumen Arsitektur</a></li>
                            </ul>
                            ...
                            ?>
                                                        <div class="ibox-content">
                                                            <form name="update_user" method="post"
                                                                action="database/updateArsitektur.php"
                                                                class="form-horizontal" enctype="multipart/form-data">

                                                                <div class="row">
                                                                    <div class="form-group"><label
                                                                            class="col-sm-2 control-label">Dinding/Tembok
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='dinding' class="form-control"
                                                                                value="<?php echo $dinding; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group"><label
                                                                            class="col-sm-2 control-label">Platfon
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='plafond' class="form-control"
                                                                                value="<?php echo $plafond; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group"><label
                                                                            ...
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='lantai_arsi' class="form-control"
                                                                                value="<?php echo $lantai_arsi; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group"><label
                                                                            class="col-sm-2 control-label">Kusen
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='kusen' class="form-control"
                                                                                value="<?php echo $kusen; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group"><label
                                                                            class="col-sm-2 control-label">Daun
                                                                            Pintu
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='daun_pintu' class="form-control"
                                                                                value="<?php echo $pintu; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group"><label
                                                                            class="col-sm-2 control-label">Daun
                                                                            ...
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='jendela' class="form-control"
                                                                                value="<?php echo $jendela; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group"><label
                                                                            ...
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='pagar' class="form-control"
                                                                                value="<?php echo $pagar; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group"><label
                                                                            class="col-sm-2 control-label">Luas
                                                                            Ruang Terbuka
                                                                            Hijau (%)
                                                                            :</label>
                                                                        <div class="col-sm-10"><input type="text"
                                                                                name='ruang_hijau' class="form-control"
                                                                                value="<?php echo $ruang_hijau; ?>">
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div class='row'>
                                                <div class="col-lg-12">
                                                    <div class="ibox">
                                                        ...
                                                        <div class="ibox-content">
                                                            <form action="database/updateDokumenArsitektur.php"
                                ...
                                if ($ext == 'pdf'){
                                    ...
                                    $extension = 'fa fa-file-o';
                                                    ...
                                                    <div class=" profile-pic containert"
                                                        ...
                                                        <div class="middle">
                                                            <a
                                                                href="database/delDokumenArsitektur.php?id=<?php echo $id_dokumen ?>"><i
