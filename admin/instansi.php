    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom page-heading">
                <div class="col-lg-12">
                    <h2><b>Instansi</b><a href="addInstansi.php"> <button
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($mysqli, "select * from tb_instansi");
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <a
                                                        href="editInstansi.php?kode_instansi=<?php echo $d['kode_instansi']; ?>"><i
                                                            data-feather="edit-2" style="margin-right:5%"></i></a>
                                                    <a href="database/delInstansi.php?kode_instansi=<?php echo $d['kode_instansi']; ?>"
