...
?>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom page-heading">
                <div class="col-lg-12">
                    <h2><b>Pengguna</b><a href="addPengguna.php"> <button
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($mysqli, "select * from tb_users");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                            <tr class="gradeX">
                                                <td><?php echo "<img src='dokumen/$d[foto]' class='img-circle' width='50' />"; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a
                                                        href="database/aktifUser.php?id_user=<?php echo $d['id_user']; ?>"><button
                                                            class="btn btn-sm btn-info">active</button></a>
                                                </td>
                                                <?php
                                                    } else { ?>
                                                <td>
                                                    <a
                                                        href="database/nonaktifUser.php?id_user=<?php echo $d['id_user']; ?>"><button
                                                            class="btn btn-sm btn-danger">non
                                                            active</button></a>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="editPengguna.php?id_user=<?php echo $d['id_user']; ?>"><i
                                                            data-feather="edit-2" style="margin-right:5%"></i></a>
                                                    <a href="database/delUser.php?id_user=<?php echo $d['id_user']; ?>"
