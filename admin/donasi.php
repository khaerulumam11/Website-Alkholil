...
<li><a href = 'login.html'>Logout</a></li>
        ...
        <div id='page-wrapper' class='gray-bg'>
            ...
            <div class='row wrapper border-bottom page-heading'>
                <div class='col-lg-12'>
                    <h2 style='margin-top:3%'><b>Donasi</b></h2>
...
$sql = 'select * from donasi LIMIT 1';
$hasil = mysqli_query( $mysqli, $sql );
$jumlah = mysqli_num_rows( $hasil );
if ( $jumlah == 0 ) {
    ?>
                                <form name='form1' id='form' method='post' action='database/addDonasi.php'
                                    enctype='multipart/form-data' class='form-horizontal'>

                                    <div class='form-group'><label class='col-lg-2 control-label'>Deskripsi*
                                        </label>
                                        <div class='col-lg-8'>
                                            <textarea id='editor2' style='height:50%' name='deskripsi' rows='10'
                                    ...
                                    <div class='form-group'>
                                        <label class='col-lg-2 control-label' style='font-size:18px'>Detail Donasi*
                                        </label>
                                    </div>

                                    <div class='form-group'>
                                        <label class='col-lg-2 control-label'> Metode 1* </label>
                                    ...
                                    <div class='form-group'>
                                        <label class='col-lg-2 control-label'> Metode 2* </label>
                                    ...
                                    <div class='form-group'>
                                        <label class='col-lg-2 control-label'> Metode 3* </label>
                                    ...
                                    <div class='form-group'>
                                        <label class='col-lg-2 control-label'> Metode 4* </label>
        ...
        while ( $d = mysqli_fetch_array( $hasil ) ) {
            ?>
                                <form name='form1' id='form' method='post'
                                    action='database/updateDonasi.php?id=<?php echo $d['DONASI_ID']; ?>'
                                    enctype='multipart/form-data' class='form-horizontal'>
                                    ...
                                    <div class='form-group'><label class='col-lg-2 control-label'>Deskripsi*
                                        ...
                                        <div class='col-lg-8'>
                                            <textarea id='editor2' style='height:50%' name='deskripsi' rows='10'
                                                cols='50' class='form-control'><?php echo $d['DESKRIPSI_UMUM'];
            ?> </textarea>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-lg-2'> <a
                                                href="database/generateQRCode1.php?id=<?php echo $d['DONASI_ID']; ?>">
                                                <button class='btn btn-sm' type='button' name='update'>Generate QR
                                                    Code</button></a>
                                        </div>
                                    </div>
