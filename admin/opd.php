    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom page-heading">
                <div class="col-lg-12">
                    <h2><b>Organisasi Perangkat Daerah (OPD)</b><a href="addOPD.php"><button
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            $data = mysqli_query($mysqli, "select * from tb_opd");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                                            <tr class="gradeX">
                                                <td><?php echo $d['kode_opd']; ?></td>
                                                <td><?php echo $d['nama_opd']; ?></td>
                                                <td><?php echo $d['deskripsi']; ?></td>
                                                <td>
                                                    <a href="editOPD.php?kode_opd=<?php echo $d['kode_opd']; ?>"><i
                                                            data-feather="edit-2" style="margin-right:5%"></i></a>
                                                    <a href="database/delOPD.php?kode_opd=<?php echo $d['kode_opd']; ?>"
                                                        onclick="return confirm('Apakah anda yakin akan menghapus data?')"><i
                                                            data-feather="trash-2"
                                                            style="color:red; margin-right:2%"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                            }
