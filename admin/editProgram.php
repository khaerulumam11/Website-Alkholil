    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom page-heading">
                <div class="col-lg-12">
                    <h2 style="margin-top:3%"><b>Program</b></h2>
   ...
   while ( $d = mysqli_fetch_array( $hasil ) ) {
       ?>
                                <form name="form1" id="form" method="post"
                                    action="database/updateProgram.php?id=<?php echo $d['PROGRAM_ID']; ?>"
                                    enctype="multipart/form-data" class="form-horizontal">

                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Deskripsi* </label>
                                        <div class="col-lg-8"><input id="deskripsi" name="deskripsi" type="text"
                                                class="form-control required" value="<?php echo $d['DESKRIPSI']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-lg-2 control-label">Program*
                                        </label>
                                        <div class="col-lg-8">
                                            <textarea id="editor2" style="height:40%" name="program" rows="6" cols="40"
                                                class="form-control"><?php echo $d['PROGRAM']; ?></textarea>
