        ...
        <div id='page-wrapper' class='gray-bg'>
            ...
            <div class='row wrapper border-bottom page-heading'>
                <div class='col-lg-12'>
                    ...
                    <label style='font-size:32px;margin-top:3%; margin-left:1%'><b>Edit Data Organisasi Perangkat Daerah
                        </b></label>
...
$result = mysqli_query( $mysqli, "SELECT * FROM tb_opd WHERE kode_opd='$id'" );

while ( $user_data = mysqli_fetch_array( $result ) ) {
    $kode_opd = $user_data['kode_opd'];
    $nama_opd = $user_data['nama_opd'];
    $deskripsi = $user_data['deskripsi'];
}
?>
                            <div class='ibox-content'>
                                <form name='update_user' method='post' action='database/updateOpd.php'
                                    class='form-horizontal'>

                                    <div class='form-group'><label class='col-lg-2 control-label'>Kode OPD</label>

                                        <div class='col-lg-8'><input type='text' name='kode_opd'
                                                value="<?php echo $kode_opd; ?>" class='form-control'>
                                        </div>
                                    </div>
                                    <div class='form-group'><label class='col-lg-2 control-label'>Nama OPD</label>

                                        <div class='col-lg-8'><input type='text' name='nama_opd'
                                                value="<?php echo $nama_opd; ?>" class='form-control'>
                                        </div>
                                    </div>
                                    <div class='form-group'><label class='col-lg-2 control-label'>Deskripsi</label>

                                        <div class='col-lg-8'>
                                            <textarea class='form-control' name='deskripsi'><?php echo $deskripsi;
?></textarea>
                                        </div>
                                    </div>
                                    <div class='form-group'>
                                        <div class='col-lg-offset-2 col-lg-10'>
                                            <input type='hidden' name='id' value=<?php echo $_GET['kode_opd'];
?>>
