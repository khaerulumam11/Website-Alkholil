...
<body>
    ...
    <header id='header' class='header fixed-top'>
        <div class='container-fluid container-xl d-flex align-items-center justify-content-between'>
            ...
            <a href='index.html' class='logo d-flex align-items-center'>
                ...
                <span>Yayasan Pendidikan Islam Al-Kholil</span>
            </a>
        ...
        <div class='container'>
            <div class='row'>
                <div class='col-lg-6 d-flex flex-column justify-content-center'>
                    <h1 data-aos='fade-up'>Yayasan Pendidikan Islam Al-Kholil</h1>
                    <?php
                                            include 'admin/database/config.php';
                                            $data = mysqli_query($mysqli, "select * from beranda ORDER BY CREATE_TIME DESC LIMIT 1");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                    <label data-aos='fade-up' data-aos-delay='400'
                        style='font-size:20px; margin-top:3%;text-align:justify'>
                        <?php echo $d['PROFIL']?>
                        <br>
                    </label>
                ...
                <div class='col-lg-6 hero-img' data-aos='zoom-out' data-aos-delay='200'>
                    <img src='admin/dokumen/fotoBeranda/<?php echo $d['GAMBAR']?>' style="border-radius:5%"
                        class='img-fluid' alt=''>
                </div>
                <?php } ?>
            </div>
    ...
    <main id="main">
            ...
            <div class='container' data-aos='fade-up'>
                <div class='row gx-0'>
                    ...
                    <div class='col-lg-12 d-flex flex-column justify-content-center' data-aos='fade-up'
                        data-aos-delay='200'>
                        <div class='content'>
                            <b><label style='font-size:22px; margin-top:3%; text-align:justify'>MUQADDIMAH</label></b>
                            <br>
                            <b><label style='font-size:18px; margin-top:3%; text-align:justify'>“DAN SESUNGGUHNYA TELAH
                            ...
                            <p style="margin-top:3%;text-align:justify">
                                Al-Qur’an adalah kalam Allah yang bernilai ibadah bagi siapa saja yang berkenan
                                berinteraksi dengannya. Ada sekian pahala dan janji agung yang telah Allah siapkan untuk
                                para pengkaji kitab suci-Nya tersebut. Terlebih bagi mereka yang mau dan mampu
                                menghafalkannya. Sehingga tidak mengherankan bahwa umat Muslim berlomba-lomba untuk
                                menjadi “pembaca terbaik” bagi kitab samawi terakhir itu.
                            </p>

                            <p style="margin-top:3%;text-align:justify">
                                Dengan berjalannya waktu, ghiroh (semangat) mereka untuk mempelajari dan menghafal
                                Al-Qur’an semakin kuat dengan bersamaan lahirnya para hafidz lintas usia dari pelbagai
                                penjuru nusantara bahkan dunia. Hal tersebut dibuktikan dengan maraknya program tahfidz
                                yang ditawarkan oleh banyak lembaga baik formal (Sekolah Islam Terpadu) maupun non
                                formal (Pesantren Tahfidz) sebagai upaya untuk menciptakan genarasi qur’an yang terus
                                berkelanjutan.

                            </p>

                            <p style="margin-top:3%;text-align:justify">
                                Sebagai bagian dari upaya tersbut, maka Yayasan Pondok Pesantren Al-Kholili mencoba
                                untuk ikut andil dalam mencetak generasi dari pelbagai wilayah untuk mewudjukan
                                cita-cita mereka. Harapannya, dengan adanya Rumah Tahfidz Zawiyah ini syiar Al-Qur’an
                                menjadi semakin membumi dan lahirlah para hafidz hafidzah yang berkualitas, berakhlakul
                                karimah dan sukses dunia akhirat. Amin.
        ...
        <section id="profil' class='about">
            ...
            <div class="container' data-aos='fade-up">
                <div class="row gx-0">
                    <center><b><label style="font-size:40px;text-align:center;margin-bottom:5%">Profil
                                Yayasan</label></b>
                    </center>
                    ...
                    <div class="col-lg-6 d-flex align-items-center' data-aos='zoom-out' data-aos-delay='200">
                        <img src="admin/dokumen/fotoBeranda/<?php echo $d['GAMBAR']?>" class=""
                            style="width:80%;height:80%;margin-left:20%;border-radius:5%" alt="">
                    </div>
                    <?php } ?>
                    <?php
                                            include 'admin/database/config.php';
                                            $data = mysqli_query($mysqli, "select * from profilyayasan ORDER BY CREATE_TIME DESC LIMIT 1");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                    <div class="col-lg-6 d-flex flex-column' data-aos='fade-up' data-aos-delay='200"
                        style="background-color:white">

                        <div class="content" style="background-color:white;margin-left :3%; margin-right:15% ">
                            <label style="text-align:justify; font-size:18px">
        ...
        <section id="features" class="features">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <!-- Feature Tabs -->
                <div class="row feture-tabs" data-aos="fade-up" style="margin-top:-1%">
                    <div class="col-lg-10">
                        ...
                        <div class="tab-content">
                            <?php
                                            include 'admin/database/config.php';
                                            $data = mysqli_query($mysqli, "SELECT visi.VISI, misi.MISI from visi join misi on visi.VISI_ID = misi.VISI_ID ORDER BY visi.CREATE_TIME DESC LIMIT 1");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                            <div class="tab-pane fade show active" id="tab1">
                                <div class="d-flex align-items-center mb-2" style="margin-top:5%">
                                    <h4><?php echo $d['VISI']?></h4>
                                </div>
        ...
        <section id="counts" class="counts">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    <?php
                                            include 'admin/database/config.php';
                                            $data = mysqli_query($mysqli, "SELECT * from fasilitas ORDER BY CREATE_TIME DESC LIMIT 1");
                                            while ($d = mysqli_fetch_array($data)) {
                                            ?>
                    <div class="col-lg-3 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="<?php echo $d['JUMLAH1']?>"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <p><?php echo $d['DESKRIPSI1']?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="<?php echo $d['JUMLAH2']?>"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <p><?php echo $d['DESKRIPSI2']?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="<?php echo $d['JUMLAH3']?>"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <p><?php echo $d['DESKRIPSI3']?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="count-box">
                            ...
                            <div>
                                <span data-purecounter-start="0" data-purecounter-end="<?php echo $d['JUMLAH4']?>"
                                    data-purecounter-duration="1" class="purecounter"></span>
                                <p><?php echo $d['DESKRIPSI4']?></p>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    <header class="section-header" style="margin-top:8%">
                        <p>Mau Konsultasi ? </p>
                    </header>
                    <center><button style="margin-top:-1%; width:25%" class="buttonCustom" type="submit">Hubungi
                            Kontak</button>
                    </center>
